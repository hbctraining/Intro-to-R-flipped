...
description: |
  This lesson introduces participants to creating data visualizations using the ggplot2 package. Participants will learn the layered grammar of graphics, how to map data to aesthetics and how to customize plots with themes and labels. Through hands‑on practice, participants will  construct scatterplots and enhance them with color, shape and other visual elements.
author:
  - Mary Piper
  - Meeta Mistry
  - Radhika Khetani
...
:::{.callout-note}
For this lesson, you will need the `new_metadata` data frame. If you do not have this in your environment, please load it from your project's `data` folder:
...
::: {.callout-note}
If you are interested in learning about plotting with base R functions, we have a short lesson [available here](Aside_basic_plots_in_r.qmd). 
:::
