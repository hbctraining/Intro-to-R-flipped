...
For this lesson, you will need the `new_metadata` data frame. If you do not have this in your environment, please download it [from here](https://github.com/hbctraining/Intro-to-R-flipped/raw/master/data/new_metadata.RData) to your project's data folder by right-clicking and "save file as" or "download file as".
