...
description: |
  This lesson introducing how to read data into R from common file formats and how to inspect data structures using essential base R functions. Participants practice importing text files, explore key arguments in functions like `read.csv()` and `read.table()` and develop skills to summarize and explore datasets effectively.
author:
  - Mary Piper
  - Meeta Mistry
  - Radhika Khetani
...
::: {.callout-tip}
# [**Exercise 1**](04_reading_and_data_inspection-Answer_key.qmd#exercise-1)
...
::: {.callout-tip}
# [**Exercise 2**](04_reading_and_data_inspection-Answer_key.qmd#exercise-2)
