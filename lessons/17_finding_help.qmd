...
description: |
  This lesson is an introduction to troubleshooting R code and finding reliable help resources. Participants learn how to clearly describe problems, share reproducible examples, interpret error messages and identify the most effective places to seek assistance, including online forums, documentation and AI tools.
author:
  - Mary Piper
  - Meeta Mistry
  - Radhika Khetani
...
::: {.callout-tip}
# [**Exercise 1**](17_finding_help-Answer_key.qmd#exercise-1)
