...
::: {.callout-tip}
# [**Exercise 1**](18_tidyverse-Answer_key.qmd#exercise-1)
...
**Important: [tidyverse](http://tidyverse.org/) is very opinionated about row names**. These packages insist that all column data (e.g. `data.frame`) be treated equally, and that special designation of a column as `rownames` should be deprecated. [Tibble](http://tibble.tidyverse.org/) provides simple utility functions to handle rownames: `rownames_to_column()` and `column_to_rownames()`.
...
<img src="../img/mov10_FA.png" width="800"/>
...
<details>
<summary><b><i>Click here to see how to do this in base R</i></b></summary>
```{r}
#| label: load_data_base_r
#| eval: false
# Read in the functional analysis results
...
::: {.callout-tip}
# [**Exercise 2**](18_tidyverse-Answer_key.qmd#exercise-2)
...
```{r}
#| label: arrange_ascending_example
...
<summary><b><i>Click here to see how to do this in base R</i></b></summary>
```{r}
#| label: arrange_descending_base_r
#| eval: false
...
```{r}
#| label: arrange_descending_example
#| eval: false
# DO NOT RUN
...
<summary><b><i>Click here to see how to do this in base R</i></b></summary>
```{r}
#| label: arrange_ascending_example_base_r
#| eval: false
# DO NOT RUN
...
::: {.callout-tip}
# [**Exercise 4**](18_tidyverse-Answer_key.qmd#exercise-4)
...
```{r}
#| label: print_dataframe
#| eval: false
View(bp_oe)
```

```{r}
#| label: render_dataframe
#| echo: false
datatable(bp_oe)
```
...
Now that we have our results ready for plotting, we can use the [ggplot2](https://ggplot2.tidyverse.org) package to plot our results. If you are interested, you can follow [this lesson](Aside_ggplot2.qmd) and dive into how to use `ggplot2` to create the plots with this dataset.
